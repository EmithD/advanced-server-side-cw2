...
export default function BlogDetail() {
  ...
  return (
    <div className="container mx-auto max-w-4xl py-8 px-4">
      {/* Back button */}
      <Button variant="ghost" onClick={() => router.back()} className="mb-6 -ml-2 flex items-center text-muted-foreground">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center mb-6">
          ...
          <span className="text-sm font-medium">{blog.user.display_name || 'Anonymous'}</span>
        </div>
      </div>
